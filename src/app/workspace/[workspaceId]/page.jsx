  ...
  return (
    <div className="flex flex-col h-screen bg-gray-950 text-white min-w-[1024px] relative">
      ...
      {/* Chat Toggle Button */}
      {
        !isChatOpen && (
            <button
              className="fixed bottom-6 right-10 z-30 py-3 font-mono px-5 flex items-center gap-2 text-xl bg-red-700/30 ring-1 ring-red-500  animate-bounce  hover:bg-orange-800 text-white rounded-full shadow-lg"
              onClick={() => setIsChatOpen(!isChatOpen)}
            >
             <MessageCircle className="h-8 w-8 " /> AIxChat
          </button>
        )
      }
