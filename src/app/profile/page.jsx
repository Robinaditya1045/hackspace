...
import StarsCanvas from "@/components/StarCanvas"; // Import StarCanvas
...
const Profile = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black text-white p-4">
      ...
      <div className="w-full max-w-md bg-black rounded-lg shadow-lg p-6 z-10">
        {/* Profile Header */}
        ...
        <div className="mt-6">
          ...
          {invites.length > 0 ? (
            invites.map((workspaceId) => (
              <div
                key={workspaceId}
                className="bg-gray-700 p-3 rounded-md flex justify-between items-center mb-3"
              >
